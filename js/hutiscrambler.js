...
function getScrambles(type,relay){
	...
	helifj="UF UR UB UL DF DR DB DL FR FL BR BL JR JL UR+ UR- UF+ UF- UF UR UB UL DF DR DB DL FR FL BR BL JR JL UR+ UR- UF+ UF- y z' x' z2 x'2 x y' y2 z".split(" "),
	...
	scrambler["3x3ll"]=scramblers["333"].getLLScramble();
	scrambler["3x3cmll"]=scramblers["333"].getCMLLScramble();
	scrambler["3x3lsll"]=scramblers["333"].getLSLLScramble();
	scrambler["3x3zbll"]=scramblers["333"].getZBLLScramble();
	scrambler["3x32gll"]=scramblers["333"].get2GLLScramble();
	scrambler["3x3pll"]=scramblers["333"].getPLLScramble();
